...
// The rest of the original client-side code is now in BlogContent.tsx
// Remove client-side BlogForm and related code from this file as they are duplicated.
export {};
 post, onSave, onCancel, saving }: { post: BlogPost; onSave: (form: BlogPost) => Promise<void>; onCancel: () => void; saving: boolean }) {
