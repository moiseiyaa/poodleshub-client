...
const Navbar = () => {
  ...
  return (
    <header 
      className="fixed top-0 left-0 w-full z-50 bg-white/90 backdrop-blur-md shadow-soft py-3 transition-all duration-300"
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="relative z-50">
            <div className="flex items-center">
              <div className="mr-2 relative w-10 h-10 bg-linear-to-br from-primary-400 to-primary-600 rounded-full flex items-center justify-center animate-pulse-glow">
                <span className="text-white text-xl font-bold">P</span>
              </div>
              <span className="text-2xl font-bold gradient-text">
                PuppyHub <span className="text-secondary-500">USA</span>
              </span>
            </div>
          </Link>
          ...
          <button
            ...
            className="md:hidden p-2 rounded-md text-gray-800 hover:text-primary-500 hover:bg-primary-50 focus:outline-none transition-colors relative z-50"
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="fixed inset-0 z-40 bg-linear-to-br from-white to-primary-50 md:hidden">
            ...
            <nav className="flex flex-col space-y-6 mt-8">
              ...
              <div>
                <button 
                  ...
                  onClick={() => setIsBreedDropdownOpen(!isBreedDropdownOpen)}
                >
                  Breeds <FaChevronDown className="ml-1 h-3 w-3" />
                </button>
